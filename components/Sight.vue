<template>
  <svg
    ...
    <defs>
      ...
      <radialGradient id="flashlight" cx="50%" cy="50%" r="50%" fx="50%" fy="50%">
        <stop offset="0%" style="stop-color: rgb(255, 255, 255); stop-opacity: 1" />
        <stop offset="6%" style="stop-color: rgb(255, 255, 255); stop-opacity: 1" />
    ...
    <g stroke="rgb(59, 156, 96)"
      ...
      fill="none"
      >
      <path v-for="x in steps(width / 16, width / 8 - 3, 6)"
        :key="x"
    ...
    <g stroke="rgb(59, 156, 96)"
      ...
      <path v-for="dy in steps(height / 16, height / 8 - 3, 6)"
        :key="dy"
        :d="`M ${width} ${height - dy} L ${spot.x} ${spot.y}`"
        />
